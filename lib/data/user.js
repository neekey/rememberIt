...
module.exports = {
     ...
     * @param newUser
     * @param newUser.name
     * @param newUser.todoist_user_id
     * @param newUser.todoist_token
     */
     ...
     * @param [updateUser.todoist_token]
     * @param [updateUser.todoist_project_id]
     * @param [updateUser.todoist_label_id]
     * @returns {*}
     */
    update: function( userId, updateUser ){
        return this.findOneStrict( userId ).then(function( user ){
            updateUser = _.pick( updateUser, [ 'todoist_token', 'todoist_project_id', 'todoist_label_id' ] );
            return user.updateAttributes( updateUser );
        });
    },
